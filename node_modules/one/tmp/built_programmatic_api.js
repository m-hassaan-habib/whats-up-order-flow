...
exampleProject.pkg(20, function(parents){
  return {
    'id':27,
    'name':'assert',
    'main':undefined,
...
exampleProject.module(27, function(/* parent */){
  return {
    'id': 'assert',
    'pkg': arguments[0],
...
exampleProject.module(21, function(/* parent */){
  return {
    'id': 'f',
    'pkg': arguments[0],
    'wrapper': function(module, exports, global, Buffer,process,require, undefined){
...
exampleProject.pkg(21, function(parents){
  return {
    'id':23,
    'name':'fruits',
    'main':undefined,
...
exampleProject.module(23, function(/* parent */){
  return {
    'id': 'index',
    'pkg': arguments[0],
    'wrapper': function(module, exports, global, Buffer,process,require, undefined){
...
exampleProject.pkg(21, 20, function(parents){
  return {
    'id':24,
    'name':'sibling',
    'main':undefined,
...
exampleProject.module(24, function(/* parent */){
  return {
    'id': 'n',
    'pkg': arguments[0],
    'wrapper': function(module, exports, global, Buffer,process,require, undefined){
...
exampleProject.module(22, function(/* parent */){
  return {
    'id': 'i',
    'pkg': arguments[0],
    'wrapper': function(module, exports, global, Buffer,process,require, undefined){
...
exampleProject.module(25, function(/* parent */){
  return {
    'id': 'lib/index',
    'pkg': arguments[0],
    'wrapper': function(module, exports, global, Buffer,process,require, undefined){
...
exampleProject.module(26, function(/* parent */){
  return {
    'id': 'index',
    'pkg': arguments[0],
    'wrapper': function(module, exports, global, Buffer,process,require, undefined){
